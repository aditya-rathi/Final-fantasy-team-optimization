...
f = -sum(X_min.*W_flat.*x1_flat,'all')- sum(X_min.*W_flat.*x2_flat,'all');
...
g8(i) = 45-X_min(i);
g9(i) = X_min(i)-90;
g10(i) = 135-X_min(20+i);
g11(i) = X_min(20+i)-450;
g12(i) = 90-X_min(40+i);
g13(i) = X_min(40+i)-450;
g14(i) = 45-X_min(60+i);
g15(i) = X_min(60+i)-270;
end


for i = 1:20
    g16(i) = X_min(i) + X_min(20+i) + X_min(40+i) + X_min(60+i) - 990
end
...
g= [g1;g2;g3;g4;g5;g6;g7;g8';g9';g10';g11';g12';g13';g14';g15';g16';gplayerlims'];
h = [h1;h2;h3;h4;h5;h6;h7];
...
%  runfmincon(F,x0_flat, nonlinfc, opts);
 ...
 for i = 1:20
     x_min_out(i) = (x_min_out(i) - 45)/(90-45);
     x_min_out(20+i) = (x_min_out(20+i) - 135)/(450-135);
     x_min_out(40+i) = (x_min_out(40+i) - 90)/(450-90);
     x_min_out(60+i) = (x_min_out(60+i) - 45)/(270-45);
 end
 
 x_min_out
 answer = -sum(x_min_out.*W_flat.*x1_out,'all')- sum(x_min_out.*W_flat.*x2_out,'all')
...
%  runfmincon(F,x0, nonlinfc, opts);
 ...
 %% Runfmincon function
 function [x fval x1_out x2_out x_min_out] = runfmincon(F,x0, nonlinfc, opts)
  x0_flat = reshape(x0,1,[]);
