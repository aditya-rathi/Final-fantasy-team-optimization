...
h = [h1;h2;h3;h4;h5;h6;h7];
 ...
 %% NLP
W = readmatrix('Exp_Score_nlp.csv');
W_flat = reshape(W,1,[]);



f = -sum((X_min.*W_flat.*x1_flat+X_min.*W_flat.*x2_flat),'all');
...
h9(i) = sum(X_min([i,20+i,40+i,60+i]))-numstarters;
...
g= [g1;g2;g3;g4;g5;g6;g7;g8';g9';g10';g11';g12';g13';gplayerlims'];
...
table(x_min_out)
 ...
 table(lambda.ineqnonlin,'VariableNames',{'Lambda inequality nonlinear constraints'})
table(lambda.eqnonlin,'VariableNames',{'Lambda equality nonlinear constraints'})
